...
\restrict 8itjBUe9fKmtwpkheItdDqCN6y4aSdCqawRNCKK2MORZIZxEO7G6aCeU3YBtlJA

-- Dumped from database version 17.6
-- Dumped by pg_dump version 17.6

-- Started on 2025-10-15 20:26:20
...
--
-- TOC entry 5048 (class 1262 OID 24757)
...
\unrestrict 8itjBUe9fKmtwpkheItdDqCN6y4aSdCqawRNCKK2MORZIZxEO7G6aCeU3YBtlJA
...
--
-- TOC entry 243 (class 1259 OID 57966)
-- Name: vista_mantenimiento_predictivo; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vista_mantenimiento_predictivo AS
 SELECT e.id AS id_equipo,
    e.name AS equipo,
    max(m."performedDate") AS ultimo_mantenimiento,
    (CURRENT_DATE - max(m."performedDate")) AS dias_transcurridos,
        CASE
            WHEN ((CURRENT_DATE - max(m."performedDate")) > 30) THEN 'Mantenimiento requerido'::text
            ELSE 'Operativo'::text
        END AS estado
   FROM (public.equipments e
     LEFT JOIN public.maintenances m ON (((e.id = m."equipmentId") AND ((m.status)::text = 'completado'::text))))
  GROUP BY e.id, e.name
  ORDER BY (CURRENT_DATE - max(m."performedDate")) DESC NULLS LAST;


ALTER VIEW public.vista_mantenimiento_predictivo OWNER TO postgres;
...
--
-- TOC entry 4854 (class 2606 OID 57877)
...
--
-- TOC entry 4856 (class 2606 OID 57879)
...
--
-- TOC entry 4858 (class 2606 OID 57881)
...
--
-- TOC entry 4860 (class 2606 OID 57883)
...
--
-- TOC entry 4862 (class 2606 OID 57885)
...
--
-- TOC entry 4864 (class 2606 OID 57887)
...
--
-- TOC entry 4866 (class 2606 OID 57889)
...
--
-- TOC entry 4868 (class 2606 OID 57891)
...
--
-- TOC entry 4870 (class 2606 OID 57893)
...
--
-- TOC entry 4872 (class 2606 OID 57895)
...
--
-- TOC entry 4874 (class 2606 OID 57897)
...
--
-- TOC entry 4877 (class 2606 OID 57898)
...
--
-- TOC entry 4878 (class 2606 OID 57903)
...
--
-- TOC entry 4875 (class 2606 OID 57908)
...
--
-- TOC entry 4876 (class 2606 OID 57913)
...
--
-- TOC entry 4880 (class 2606 OID 57961)
...
--
-- TOC entry 4881 (class 2606 OID 57918)
...
--
-- TOC entry 4882 (class 2606 OID 57923)
...
--
-- TOC entry 4885 (class 2606 OID 57928)
...
--
-- TOC entry 4883 (class 2606 OID 57933)
...
--
-- TOC entry 4879 (class 2606 OID 57938)
...
--
-- TOC entry 4884 (class 2606 OID 57943)
...
--
-- TOC entry 4886 (class 2606 OID 57948)
...
-- Dependencies: 243
-- Name: TABLE vista_mantenimiento_predictivo; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.vista_mantenimiento_predictivo TO PUBLIC;


-- Completed on 2025-10-15 20:26:20
